  ...
  return (
    <div className="p-6 font-sans border rounded-md shadow-md bg-white">
      ...
      <div className="flex gap-4 mb-6">
        <button className="bg-[var(--accent-1)] text-white px-4 py-2 rounded-md">
          Type 1 ✕
        </button>
        <button className="border border-gray-300 px-4 py-2 rounded-md bg-gray-100">
          + Add New Type
        </button>
      </div>
      ...
      <div className="flex gap-8">
        {/* Meal Card 1 */}
        <div className="w-80 border border-grey-500 rounded-md px-2 py-2 pr-4">
