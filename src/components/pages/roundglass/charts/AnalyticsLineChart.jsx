 ...
 * @param {boolean} props.smooth - Use smooth curves
 */
export default function AnalyticsLineChart({
  ...
  const chartData = useMemo(() => {
    if (!graphData) return [];
    return transformLineChartData(graphData);
  }, [graphData]);
