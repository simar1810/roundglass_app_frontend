import { changeWorkoutPlans, customWorkoutUpdateField, weeklyWorkoutRP } from "@/config/state-reducers/custom-workout";
...
export default function WeeklyWorkoutCreation() {
  ...
  async function saveCustomWorkout() {
    try {
      setLoading(true);
      const formData = weeklyWorkoutRP(state);
