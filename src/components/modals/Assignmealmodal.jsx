...
function AssignMealPlanContainer({ planId }) {
  ...
  const assignedClients = data.data.assignedClients.filter(client => client.name.toLowerCase().includes(searchQuery.toLowerCase()));
  const unassignedClients = data.data.unassignedClients.filter(client => client.name.toLowerCase().includes(searchQuery.toLowerCase()));
