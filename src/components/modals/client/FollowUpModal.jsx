    ...
    <div className="p-4">
        ...
        <div>
          <div className="pr-2 flex items-center gap-2 justify-between">
            ...
            >
              ...
              />
              <Label htmlFor="weight-kg" className="mr-3">
                Kg
              </Label>
              <input
                id="weight-pounds"
                ...
                className="w-[14px] h-[14px]"
                onChange={() =>
                  dispatch(changeFieldvalue("weightUnit", "Pounds"))
                }
              />
          ...
          <FormControl
            ...
            onChange={(e) =>
              dispatch(changeFieldvalue("weight", e.target.value))
            }
          />
        </div>
        <FormControl
      ...
      <div className="mt-8 grid grid-cols-2 items-end gap-x-6">
        <div className="">
          <p>Follow Up Type</p>
          <RadioGroup
            value={healthMatrix.followUpType}
          ...
          >
            <input
              ...
              onChange={() =>
                dispatch(changeFieldvalue("followUpType", "8day"))
              }
            />
            <Label htmlFor="follow-up-8day" className="mr-3">
              8 Day
            </Label>
            <input
              id="follow-up-custom"
              ...
              className="w-[14px] h-[14px]"
              onChange={() =>
                dispatch(changeFieldvalue("followUpType", "custom"))
              }
            />
            <Label htmlFor="follow-up-custom">Custom</Label>
          </RadioGroup>
        </div>
        {healthMatrix.followUpType === "custom" && (
          <FormControl
            type="date"
            className="[&_.label]:font-[400] [&_.input]:text-[14px]"
      ...
      <Button
        onClick={() => {
          ...
          if (!completed.success)
            toast.error(`Field ${completed.field} is required!`);
  ...
  async function createFollowUp() {
    try {
      ...
      const response = await sendData(
        `app/add-followup?clientId=${clientId}`,
        data
      );
    ...
    <div className="mt-4 col-span-2">
      ...
      <div className="grid grid-cols-5 gap-2">
        <div
          ...
          className={`border rounded p-3 text-center cursor-pointer w-24 ${
            healthMatrix.body_composition === "Slim" &&
            "border-[var(--accent-1)]"
          }`}
        >
        ...
        <div
          ...
          className={`border rounded p-3 text-center cursor-pointer w-24 ${
            healthMatrix.body_composition === "Medium" &&
            "border-[var(--accent-1)]"
          }`}
        >
          <div className="w-[83px] h-[106px] mx-auto mb-1 flex items-center justify-center overflow-hidden">
        ...
        <div
          ...
          className={`border rounded p-3 text-center cursor-pointer w-24 ${
            healthMatrix.body_composition === "Fat" &&
            "border-[var(--accent-1)]"
          }`}
        >
          <div className="w-[83px] h-[106px] mx-auto mb-1 flex items-center justify-center overflow-hidden">
